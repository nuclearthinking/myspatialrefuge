...
-- Spatial Well messages
PM.SPATIAL_WELL_BUILT = "SPATIAL_WELL_BUILT"
PM.SPATIAL_WELL_BUILDING = "SPATIAL_WELL_BUILDING"
PM.SPATIAL_WELL_ALREADY_BUILT = "SPATIAL_WELL_ALREADY_BUILT"
PM.SPATIAL_WELL_INVALID_LOCATION = "SPATIAL_WELL_INVALID_LOCATION"
PM.SPATIAL_WELL_MISSING_RESOURCES = "SPATIAL_WELL_MISSING_RESOURCES"
PM.SPATIAL_WELL_BUILD_FAILED = "SPATIAL_WELL_BUILD_FAILED"
PM.SPATIAL_WELL_NOT_IN_REFUGE = "SPATIAL_WELL_NOT_IN_REFUGE"
PM.SPATIAL_WELL_MOVING = "SPATIAL_WELL_MOVING"
PM.SPATIAL_WELL_MOVED = "SPATIAL_WELL_MOVED"
PM.SPATIAL_WELL_MOVE_FAILED = "SPATIAL_WELL_MOVE_FAILED"
PM.CANNOT_MOVE_SPATIAL_WELL_YET = "CANNOT_MOVE_SPATIAL_WELL_YET"
...
local MessageToTranslationKey = {
    ...
    [PM.SPATIAL_WELL_BUILT] = "IGUI_SpatialWellBuilt",
    [PM.SPATIAL_WELL_BUILDING] = "IGUI_SpatialWellBuilding",
    [PM.SPATIAL_WELL_ALREADY_BUILT] = "IGUI_SpatialWellAlreadyBuilt",
    [PM.SPATIAL_WELL_INVALID_LOCATION] = "IGUI_SpatialWellInvalidLocation",
    [PM.SPATIAL_WELL_MISSING_RESOURCES] = "IGUI_SpatialWellMissingResources",
    [PM.SPATIAL_WELL_BUILD_FAILED] = "IGUI_SpatialWellBuildFailed",
    [PM.SPATIAL_WELL_NOT_IN_REFUGE] = "IGUI_SpatialWellNotInRefuge",
    [PM.SPATIAL_WELL_MOVING] = "IGUI_SpatialWellMoving",
    [PM.SPATIAL_WELL_MOVED] = "IGUI_SpatialWellMoved",
    [PM.SPATIAL_WELL_MOVE_FAILED] = "IGUI_SpatialWellMoveFailed",
    [PM.CANNOT_MOVE_SPATIAL_WELL_YET] = "IGUI_CannotMoveSpatialWellYet",
}
...
-- @param messageKey string - one of PM.* constants
-- @param ... - format arguments passed to the game translator
...
function PM.GetFormattedText(messageKey, ...)
    ...
    -- Let the game translator apply placeholders from JSON translations.
    if getText then
        local ok, result = pcall(function()
            return getTextFormatted(translationKey, unpack(args))
        end)
